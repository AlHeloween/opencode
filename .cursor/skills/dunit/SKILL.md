...
- Test project: `artefacts\docs\examples\project-agnostic\tests\ProjectTests.dpr`
- Test units: `artefacts\docs\examples\project-agnostic\tests\TestCore.pas`, `artefacts\docs\examples\project-agnostic\tests\TestServices.pas`

## How to add a new test

1. Add a new unit such as `tests\TestSomething.pas`.
2. Register it in the local DUnit project file. See `artefacts\docs\examples\project-agnostic\tests\ProjectTests.dpr` for the documentation fixture.

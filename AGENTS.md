...
| `packages/opencode/src/session/prompt/opencode_prompts_kernel.txt` | manual copy | `copy /Y opencode_prompts_kernel.py packages\opencode\src\session\prompt\opencode_prompts_kernel.txt` (Windows) or `cp opencode_prompts_kernel.py packages/opencode/src/session/prompt/opencode_prompts_kernel.txt` (Linux) |

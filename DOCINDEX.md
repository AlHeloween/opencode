...
class DocIndex:
    ...
    technical_docs: list[DocRecord] = field(default_factory=lambda: [
        ...
        DocRecord("docs/reasoning-framework.md", "Local_Development", "Reasoning framework architecture: kernel / SPECS / IR layering", last_verified="2026-07-31"),
        ...
        DocRecord("docs/kernel-stability-principles.md", "Local_Development", "Post-mortem principles keeping the kernel byte-stable and assembly-safe"),

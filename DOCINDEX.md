...
class DocIndex:
    ...
    technical_docs: list[DocRecord] = field(default_factory=lambda: [
        ...
        DocRecord("docs/gateway-protocol-status.md", "Local_Development", "TUI gateway protocol row: selected transport event, request correlation, and unknown state", last_verified="2026-09-24"),
        ...
        DocRecord("docs/compaction.md", "Local_Development", "Compaction contract: s/m* layers, 64K sidecar cadence, 32K sidecar generation floor (16K reasoning window + 16K stored body), finish-step cost/cache accounting, star bounds 32K+32K, and the State Vector Manifest lineage of ## Semantic Vector with the full worked example inline", last_verified="2026-09-20"),

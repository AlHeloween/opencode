 ...
 * 
 * Usage: bun run experiments/2026-07-18_token-calibration-test/extract_checkpoint.ts
 */
import fs from "fs"
...
async function main() {
  ...
  try {
    ...
    const outputPath = path.join("experiments", "2026-07-18_token-calibration-test", "checkpoint_sample.json")

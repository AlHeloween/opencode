...
```bash
bun run experiments/2026-07-28_rotating-cube-3d/smoke.ts
```
...
```bash
# Python 3
python -m http.server 8080 -d experiments/2026-07-28_rotating-cube-3d/
# Then open http://localhost:8080/web.html

# OR just open the file directly
start experiments/2026-07-28_rotating-cube-3d/web.html
```

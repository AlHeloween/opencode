 ...
 *
 * Usage:
 *   bun run experiments/2026-07-28_tui-image-rendering/render-full-pipeline.ts
 *   bun run experiments/2026-07-28_tui-image-rendering/render-full-pipeline.ts --protocol kitty
 *   bun run experiments/2026-07-28_tui-image-rendering/render-full-pipeline.ts --protocol sixel
 *   bun run experiments/2026-07-28_tui-image-rendering/render-full-pipeline.ts --protocol symbols
 */

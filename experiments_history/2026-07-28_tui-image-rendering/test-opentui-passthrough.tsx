 ...
 *
 * Usage:
 *   bun run experiments/2026-07-28_tui-image-rendering/test-opentui-passthrough.tsx
 */
...
if (isMain) {
  console.log("OpenTUI passthrough test — run with: bun test experiments/2026-07-28_tui-image-rendering/test-opentui-passthrough.tsx")

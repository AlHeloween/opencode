...
**`experiments/2026-08-18_cache-alignment-smoke/`** — живая лаборатория KAT-кеша:
...
1. Прогнать `experiments/2026-08-18_cache-alignment-smoke/smoke_kat_cache_preserve.py` (V6, с флагом)

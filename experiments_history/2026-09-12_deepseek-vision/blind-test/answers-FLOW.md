...
## Layout FLOW: 4 pages, 359524 bytes
...
export extractSemanticVector
export buildMessageStar
export isSummaryText
export isSummaryAssistantMessage
export isSummaryUserMessage
export isSummaryMessage
export selectRecentTail
export buildSummaryBlock
export computeOpenWindowTokens
export countContentChars
export renderMessageText
export summarisePrompt
export messageStarTokens
export isRenderableStar
export isFoldable
export isOverflow
export truncateHead
export truncateTail
...
export summariseSummary
export formatPlanStateText
typeSummaryEntry
typeTextStage
formatSystemExpert
buildMessageStar
...
CHARS_PER_TOKEN = 4
RECENT_MIN_TOKENS = 32_000
MAX_SUMMARY_BODY_TOKENS = 65_536
TAIL_TOOL_KEEP_FULL = 3
TAIL_TOOL_HEAD_LINES = 40
TAIL_TOOL_TAIL_LINES = 10
SUMMARY_TERMINAL_MARKER = "[...]"


### specific value (tokens=3895)

SUMMARY_INTERVAL_TOKENS=40000
MAX_SUMMARY_BODY_TOKENS=20480


### purpose + line (tokens=3889)

PURPOSE: Computes the exact token count of the full message list that will be sent by constructing the actual request message via `buildMessageStar` and estimating tokens from its character length, rather than using the model's context window.
LINE: ~212

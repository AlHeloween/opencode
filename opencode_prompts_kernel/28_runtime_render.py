...
def render_algorithm_card() -> str:
    ...
    lines = [
        ...
        "    execute_medoid,              # agent-side contract: execute one task (REUSE+SMOKE.BEFORE)",
        ...
        "# SMOKE.BEFORE: baseline oracles BEFORE first edit (record [Exact]).",
        ...
        "# Re-run SMOKE.BEFORE oracles; compare against baseline.",

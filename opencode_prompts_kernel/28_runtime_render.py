...
def render_algorithm_card() -> str:
    ...
    lines = [
        ...
        "#   select_medoids_tasks, adaptive_k, adaptive_depth, lsystem_rewrite",
        ...
        "",
        "    # 3. fractal over-generate — adaptive depth (1–3 by peaks/evidence)",
        ...
        "    candidates = fractal_over_generate(model, seeds, depth=depth)",
        "",

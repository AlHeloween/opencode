/**
 * Fetch DeepSeek V4 Pro tokenizer model and extract BPE data.
 *
 ...
 *
 * Usage: bun run scripts/fetch-deepseek-tokenizer.ts
 */

const HF_REPO = "deepseek-ai/DeepSeek-V4-Pro"
...
const outputUrl = new URL("../src/tokenizers/deepseek-v4/model.json", import.meta.url)
const OUTPUT_PATH = process.platform === "win32"
  ? outputUrl.pathname.slice(1) // strip leading "/" from "/D:/..."
  : outputUrl.pathname

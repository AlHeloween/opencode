...
const TIPS = [
  ...
  "Run {highlight}/agents{/highlight} or {highlight}Ctrl+X A{/highlight} to configure agents, models, and reasoning effort",
  themeTip,
  ...
  "Run {highlight}opencode --version{/highlight} to check your installed version",
  ...
  "Permission {highlight}destructive{/highlight} gates rm -rf / force-push / git checkout — not covered by bash:allow",

...
export const Info = Schema.Struct({
  ...
  default_agent: Schema.optional(Schema.String).annotate({
    description:
      "Default agent to use when none is specified. Must be a primary agent. Falls back to 'build_mode' if not set or if the specified agent is invalid.",
  }),
    ...
    const loadInstanceState = Effect.fn("Config.loadInstanceState")(
      function* (ctx: InstanceContext) {
        ...
        Flag.fromConfig({
          ...
          OPENCODE_MARKDOWN: result.experimental?.markdown,
...
export const ENV_TO_CONFIG_MAP: Record<string, string> = {
  ...
  OPENCODE_MARKDOWN: "experimental.markdown",

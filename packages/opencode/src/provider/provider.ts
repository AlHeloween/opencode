...
import { Service as GatewayService, defaultLayer as gatewayLayer } from "./gateway/mod"
...
export namespace Provider {
  ...
  const layer: Layer.Layer<Service, never, Config.Service | Auth.Service | Plugin.Service | GatewayService> =
    Layer.effect(
      Service,
      Effect.gen(function* () {

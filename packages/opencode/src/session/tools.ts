    ...
    Effect.gen(function* () {
      ...
      const hint =
        mode === "reasoning_mode" || mode === "reasoning"
          ? ` In reasoning_mode only checkstate, permanent memory (file .opencode/data/memory/reasoning.md), and reasoningexit are authorized. Do not call dbread, messagesearch, session-read, or other inspection tools.`
          : ""

...
parent identity, child nodes bind to it, and `root@v1` commits their canonical
IDs. The current canonical state is `root@v1`.
...
RVP/root@cht1:sha256:b752c3055e05ba4becaf7e37499f740f997012195ef5c376ec127cac17888296  # v0
  ...
  -> RVP/root@cht1:sha256:ff3e2c2bdbf6177008ecd9c0c24dce37de30d531f35c750d136cfb39ba8d7d76  # v1/current
```
...
| `RVP/T`<br>`@cht1:sha256:135a61ab476436a5ac8d6bc34dce14df64587731d8a81cc04da493bcd7947133` | `[{"grapheme pool":.45,"Unicode sequence":.35,"cell metric":.20},["Text cluster fidelity"],CHT]` | `active / 0.00 / .15` | parent `root@v0`; deps `[R]`; `RVP/T/M0001` | Evidence `abb1b4f7d,7c597fcd1`; blocker `no shaping/fallback`; next `glyph cache then HarfBuzz/fallback`. |
...
| `RVP/H`<br>`@cht1:sha256:8b73478021448dbb24a609e9530e3537bf9e32f066f67a7c6e50b3fcc16406a3` | `[{"native harness":.50,"deterministic pixels":.30,"CI oracle":.20},["Reproducible native proof"],CHT]` | `pending / 0.00 / .10` | parent `root@v0`; deps `[R,C]`; `RVP/H/M0001` | Blocker `no Windows-compatible compositor harness`; next `runnable pixel oracle`. |
...
```text
logical_id: RVP/root
canonical_id: RVP/root@cht1:sha256:ff3e2c2bdbf6177008ecd9c0c24dce37de30d531f35c750d136cfb39ba8d7d76
previous_version_id: RVP/root@cht1:sha256:b752c3055e05ba4becaf7e37499f740f997012195ef5c376ec127cac17888296
...
message_chain_head: RVP/root/M0010
evidence_root: oracle:native-build+library-build+targeted-tests
next_transition: advance only RVP/T and RVP/S locally; accept RVP/W only from direct Windows Terminal evidence
```

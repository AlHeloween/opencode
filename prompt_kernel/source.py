...
GATES = (
    ...
    Gate(
        ...
        local_rules=(
            ...
            _rule("G1", "LOUD_FAILURE", "Between two instruments prefer the one whose failure is VISIBLE. A scanner returns matches, so it looks successful while missing dynamic dispatch, re-exports and runtime binding; an index answers or says it has none. Silent incompleteness ends the search, which is why it costs most."),

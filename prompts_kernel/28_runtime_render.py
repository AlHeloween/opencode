...
def render_algorithm_card() -> str:
    ...
    lines = [
        ...
        "#   emit_state (v6: +out_of_scope, +terminal), delta_l1, PLANNING (fractal_only)",
        ...
        "# v6: kernel auto-materializes medoids into task store (authoritative).",
        ...
        "    out_of_scope=discarded,        # tasks that didn't pass Goal-SV threshold",
        "    terminal=(not residual and not blockers),  # true terminal only when both empty",
        ")",
        "# Terminal modes (v6):",
        "#   TERMINAL_SUCCESS  — residual=[], blockers=[]",
        "#   TERMINAL_BLOCKED  — residual=[], blockers≠[]",
        "#   TERMINAL_OUT_OF_SCOPE — residual=[], all tasks in out_of_scope",
